...
（关于 `callNative` 进程的进一步介绍，可以在 [How it works](http://weex.apache.org/cn/advanced/how-it-works.html)中的 JS Framework 部分看到 ）
...
##### 参数
  ...
  * `animated {boolean}` 0.10+：是否需要附带滚动动画，默认是`true`
