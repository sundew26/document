...
{% img [box-model] http://vuex.vuejs.org/zh-cn/images/vuex.png Vuex %}
...
* `history`: 依赖 HTML5 History API 和服务器配置。查看 [HTML5 History](https://router.vuejs.org/zh-cn/essentials/history-mode.html) 模式。
